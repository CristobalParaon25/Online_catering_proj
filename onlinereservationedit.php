<?php
    ...
    $sql = "SELECT id,contactName,orderName,orderDate, address, orderTime, heads, schedule,venue,contact, (heads*250) AS price,message
                                ...
                                <div class="card border-0 shadow tables-color">
                                    ...
                                    <div class="card-content">
                                        ...
                                        <div class="container-fluid col-lg-11 col-sm-8 col-md-10 bg-gray-300 rounded">
                                            <?php
                                                $id = $_GET['id'];
                                                $sql = "select * from online_reservations where id = ".$id;
                                                $result = $conn->query($sql);
                                                $row = $result->fetch_assoc();
                                            ?>
                                            <form action = "onlinereservationeditsave.php" method="post">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-4">
                                                        <div class="form-group">
                                                            ...
                                                            <textarea class="form-control"  name="message" value="<?=$row['message']?>"></textarea>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="row">
